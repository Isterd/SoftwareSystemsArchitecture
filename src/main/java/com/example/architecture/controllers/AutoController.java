...
import com.example.architecture.statistics.DeviceStat;
import com.example.architecture.statistics.SourceStat;
...
public class AutoController {
    ...
    public AutoController(ArchitectureFX architectureFX) {
